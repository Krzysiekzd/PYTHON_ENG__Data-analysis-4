...
def main():
    ...
    p = figure(title="Male deaths in Luxemburg 2011-2020", x_axis_label='Year', y_axis_label='Deaths',
        max_width=700, height=500,y_range=(1800, 2400),x_range=(2010.5,2020.5))
    p.line(df['Year'], df['Deaths_males'], line_width=2)
